...
Route.route('/')
    ...
    .post(Auth.checkToken, Auth.permission('/category/', DEFAULT_VALUE.EDIT, DEFAULT_VALUE.READ, DEFAULT_VALUE.DELETE), Upload.single('image'), AsyncHandle(CategoryController.create))
    .get(
